...
public class Demo5 {
	...
	public static void main(String[] args) throws SQLException{
		...
		try
		{
			//DriverManager.registerDriver(new oracle.jdbc.driver.OracleDriver());//java8 automatically loads the driver
			...
			int d1=deleteSt.executeUpdate();
			System.out.println("Account deleted "+d1);
